...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--type', choices=['char', 'bpe'], default='char', help='Tokenizer type to test'
    )
    parser.add_argument(
        '--vocab_size', type=int, default=300, help='Vocabulary size for BPE (default: 300)'
    )
    parser.add_argument(
        '--text', type=str, default=None, help='Text to tokenize (default: sample text)'
    )
